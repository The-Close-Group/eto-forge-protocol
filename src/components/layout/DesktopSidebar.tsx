    ...
    <>
      ...
      <div className="flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
        ...
        <Link to="/" className="flex items-center gap-2.5 px-3 py-3 mb-2">
          ...
          >
            <span className="font-semibold text-[15px]">Stakent</span>
        ...
        >
          <span className="text-[11px] text-muted-foreground">Top Staking Assets</span>
        </motion.div>
        ...
        >
          <div className="tab-list-custom">
            <button className="tab-trigger-custom tab-trigger-custom-active flex-1">Staking</button>
            <button className="tab-trigger-custom flex-1">Stablecoin</button>
          </div>
        </motion.div>
          ...
          {navigationItems.map((item) => (
            ...
            >
              ...
              >
                ...
                {item.badge && (
                  <span className="px-1.5 py-0.5 rounded text-[9px] bg-muted text-muted-foreground font-medium">
                    {item.badge}
                  </span>
                )}
                {item.external && (
