...
import { 
  Search, Settings, Bell, Plus, Wallet, User, LogOut, 
  Calculator, ChevronDown, Copy, Check, ExternalLink, RefreshCw,
  FlaskConical
} from "lucide-react";
...
export function TopNavBar({ onRefresh, onDeposit, onSearch }: TopNavBarProps) {
  ...
  const { getTotalStaked, getTotalRewards } = useStakingContext();
          ...
          <div className="flex items-center gap-1">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem onClick={() => toast.info("Calculator coming soon")} className="py-2">
