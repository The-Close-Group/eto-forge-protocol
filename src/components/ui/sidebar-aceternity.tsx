  ...
  return (
    <>
      <motion.div
        ...
        animate={{
          width: animate ? (open ? "300px" : "69px") : "300px",
        }}
        transition={{
          width: {
            type: "tween",
...
export const SidebarLink = ({
  ...
  return (
    <a
      href={link.href}
      className={cn(
        "flex items-center justify-start gap-2 group/sidebar py-2 px-2 rounded-lg hover:bg-accent transition-colors duration-200",
        className
      )}
      {...props}
    >
