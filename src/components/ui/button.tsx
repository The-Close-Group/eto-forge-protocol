...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-[13px] font-medium transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-transparent border border-[#3a3a3c] hover:border-[#5a5a5c] hover:bg-[#ffffff08] text-muted-foreground hover:text-foreground",
        destructive: "bg-transparent border border-destructive/50 hover:border-destructive hover:bg-destructive/10 text-destructive",
        outline: "bg-transparent border border-[#3a3a3c] hover:border-[#5a5a5c] hover:bg-[#ffffff08] text-muted-foreground hover:text-foreground",
        secondary: "bg-transparent border border-[#3a3a3c] hover:border-[#5a5a5c] hover:bg-[#ffffff08] text-muted-foreground hover:text-foreground",
        ghost: "hover:bg-[#ffffff08] text-muted-foreground hover:text-foreground",
        ...
        primary: "bg-primary text-primary-foreground font-semibold hover:bg-primary/85",
      },
      size: {
