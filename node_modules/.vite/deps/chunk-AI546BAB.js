...
async function getNFTAsset(options) {
  ...
  switch (true) {
    case erc721: {
      const { getNFT } = await import("./getNFT-CWWWT2LE.js");
      return getNFT(options);
    }
    case erc1155: {
      const { getNFT } = await import("./getNFT-S3GRBFJU.js");
      return getNFT(options);
    }
    default: {
...
async function isListingValid(options) {
  ...
  if (erc721) {
    const [{ isApprovedForAll }, { getApproved }, { ownerOf }] = await Promise.all([
      import("./isApprovedForAll-5KZV23X2.js"),
      import("./getApproved-ENH5OIRA.js"),
      import("./ownerOf-M2IP7GUD.js")
    ]);
  ...
  if (erc1155) {
    const [{ isApprovedForAll }, { balanceOf }] = await Promise.all([
      import("./isApprovedForAll-PABAOEYV.js"),
      import("./balanceOf-TYCDPR3G.js")
    ]);
...
//# sourceMappingURL=chunk-AI546BAB.js.map
