...
async function toSerializableTransaction(options) {
  ...
  if (isZkSync) {
    const { getZkGasFees } = await import("./send-eip712-transaction-TNWDXNVO.js");
  ...
  let [data, nonce, gas, feeData, to, accessList, value, authorizationList, type] = await Promise.all([
    ...
    (async () => {
      ...
      return from ? await import("./eth_getTransactionCount-N77KSIWI.js").then(({ eth_getTransactionCount }) => eth_getTransactionCount(rpcRequest, {
...
//# sourceMappingURL=chunk-RYC6SPTJ.js.map
