...
import {
  Buy_exports,
  Sell_exports
} from "./chunk-SCKUGH2L.js";
import {
  status
} from "./chunk-LRFI2XID.js";
import {
  decimals
...
import {
  ...
  getSelector,
  getSignatureHash
} from "./chunk-VBPZWQ5K.js";
import {
  parseEventLogs
} from "./chunk-NPUZ6GVZ.js";
import {
...
function Field2(ORDER, bitLenOrOpts, isLE4 = false, opts = {}) {
  ...
  const f = Object.freeze({
    ...
    fromBytes: (bytes, skipValidation = true) => {
      ...
      let scalar = isLE4 ? bytesToNumberLE(bytes) : bytesToNumberBE2(bytes);
      if (modOnDecode)
...
function _splitEndoScalar(k, basis, n) {
  ...
  if (k2neg)
    k2 = -k2;
  const MAX_NUM = bitMask2(Math.ceil(bitLen2(n) / 2)) + _1n7;
...
function weierstrassN(CURVE, curveOpts = {}) {
  ...
  class Point3 {
    ...
    static fromHex(hex) {
      const P = Point3.fromAffine(fromBytes6(ensureBytes2("pointHex", hex)));
      P.assertValidity();
      return P;
    }
...
function ecdsa(Point3, hash3, ecdsaOpts = {}) {
  ...
  const hmac_ = ecdsaOpts.hmac || ((key, ...msgs) => hmac(hash3, key, concatBytes2(...msgs)));
  const { Fp: Fp3, Fn } = Point3;
  const { ORDER: CURVE_ORDER, BITS: fnBits } = Fn;
  const seedLen = getMinHashLength2(CURVE_ORDER);
  const lengths = {
    secret: Fn.BYTES,
    public: 1 + Fp3.BYTES,
  ...
  class Signature {
    ...
    static fromBytes(bytes, format4 = "compact") {
      if (format4 === "compact") {
        const L = Fn.BYTES;
        abytes2(bytes, L * 2);
    ...
    static fromHex(hex, format4) {
      return this.fromBytes(hexToBytes(hex), format4);
    }
  ...
  function sign5(msgHash, secretKey, opts = defaultSigOpts) {
    ...
    const drbg = createHmacDrbg(hash3.outputLen, Fn.BYTES, hmac_);
  ...
  function verify5(signature, msgHash, publicKey, opts = defaultVerOpts) {
    ...
    if (format4 === void 0) {
      ...
      if (format4 === "compact" || format4 === "der") {
        if (typeof sg !== "string" && !isBytes(sg))
          throw new Error('"der" / "compact" format expects Uint8Array signature');
        _sig = Signature.fromBytes(ensureBytes2("sig", sg), format4);
      } else if (format4 === "js") {
...
@noble/curves/esm/p256.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-ITNC2GWI.js.map
