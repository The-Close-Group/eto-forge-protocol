import {
  getEcosystemInfo
} from "./chunk-YTVGBUSR.js";
import {
  track
} from "./chunk-GWMZUXMP.js";
import {
  getCachedChain,
...
function createInAppWallet(args) {
  ...
  return {
    autoConnect: async (options) => {
      const { autoConnectInAppWallet } = await import("./wallet-HN3HND2K.js");
    ...
    connect: async (options) => {
      const { connectInAppWallet } = await import("./wallet-HN3HND2K.js");
      const connector = await getOrCreateInAppWalletConnector(options.client, connectorFactory, ecosystem);
      await resolveSmartAccountOptionsFromEcosystem(options);
...
//# sourceMappingURL=chunk-PRSH453I.js.map
