import {
  parseNftUri
} from "./chunk-32KDFE53.js";
import {
  useQuery
} from "./chunk-B2Y6DXIZ.js";
import {
  getWalletBalance
} from "./chunk-26UHHXXS.js";
import {
  getWalletInfo
} from "./chunk-KSCJWC7T.js";
import {
  getInstalledWalletProviders
} from "./chunk-QCERWD4D.js";
import {
  ethereum
} from "./chunk-6YVISVTF.js";
import {
  webLocalStorage
...
import {
  getClientFetch
} from "./chunk-HPL7DIM2.js";
import {
  labelhash
} from "./chunk-BKJYNEUX.js";
import {
  bytesToHex,
  concat,
  decodeAbiParameters
...
function useWalletBalance(options, queryOptions) {
  ...
  return useQuery({
    ...queryOptions,
    enabled: ((queryOptions == null ? void 0 : queryOptions.enabled) === void 0 || queryOptions.enabled) && !!chain && !!client && !!address,
    queryFn: async () => {
      if (!chain) {
...
function useWalletImage(id) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const { getInstalledWalletProviders: getInstalledWalletProviders2 } = await import("./mipdStore-XLITK4G5.js");
      const mipdImage = (_a = getInstalledWalletProviders2().find((x) => x.info.rdns === id)) == null ? void 0 : _a.info.icon;
      if (mipdImage) {
        return mipdImage;
      }
...
function WalletProvider(props) {
  return (0, import_jsx_runtime.jsx)(WalletProviderContext.Provider, { value: props, children: props.children });
}
...
function CustomThemeProvider(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(CustomThemeCtx.Provider, { value: themeObj, children });
}
...
var BackButton = (props) => {
  return (0, import_jsx_runtime3.jsx)(IconButton, { onClick: props.onClick, style: { transform: "translateX(-25%)", ...props.style }, type: "button", children: (0, import_jsx_runtime3.jsx)(ChevronLeftIcon, { height: iconSize.md, width: iconSize.md }) });
};
...
function ModalHeader(props) {
  ...
  return (0, import_jsx_runtime4.jsxs)("div", { style: {
    ...
    position: "relative"
  }, children: [onBack && (0, import_jsx_runtime4.jsx)(BackButton, { onClick: onBack, style: {
    left: 0,
    position: "absolute",
    top: 0
  } }), (0, import_jsx_runtime4.jsx)(Container, { center: "both", flex: "row", gap: "xs", children: typeof title === "string" ? (0, import_jsx_runtime4.jsx)(ModalTitle, { children: title }) : title })] });
}
var Line = StyledDiv(() => {
  const theme = useCustomTheme();
  return {
...
function Container(props) {
  ...
  return (0, import_jsx_runtime4.jsx)(Box, { bg: props.bg, borderColor: props.borderColor, color: props.color, "data-animate": props.animate, "data-scrolly": props.scrollY, style: {
    ...styles,
    ...props.style
...
async function fetchWalletImage(props) {
  var _a;
  const { getInstalledWalletProviders: getInstalledWalletProviders2 } = await import("./mipdStore-XLITK4G5.js");
  const mipdImage = (_a = getInstalledWalletProviders2().find((x) => x.info.rdns === props.id)) == null ? void 0 : _a.info.icon;
  if (mipdImage) {
    return mipdImage;
  }
...
var EmailIcon = (props) => {
  return (0, import_jsx_runtime6.jsxs)("svg", { fill: "none", height: props.size, role: "presentation", viewBox: "0 0 16 16", width: props.size, xmlns: "http://www.w3.org/2000/svg", children: [(0, import_jsx_runtime6.jsx)("path", { d: "M13.3335 2.6665H2.66683C1.93045 2.6665 1.3335 3.26346 1.3335 3.99984V11.9998C1.3335 12.7362 1.93045 13.3332 2.66683 13.3332H13.3335C14.0699 13.3332 14.6668 12.7362 14.6668 11.9998V3.99984C14.6668 3.26346 14.0699 2.6665 13.3335 2.6665Z", stroke: props.color ?? "currentColor", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime6.jsx)("path", { d: "M14.6668 4.6665L8.68683 8.4665C8.48101 8.59545 8.24304 8.66384 8.00016 8.66384C7.75728 8.66384 7.51931 8.59545 7.3135 8.4665L1.3335 4.6665", stroke: props.color ?? "currentColor", strokeLinecap: "round", strokeLinejoin: "round" })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/FingerPrintIcon.js
var import_jsx_runtime7 = __toESM(require_jsx_runtime(), 1);
var FingerPrintIcon = (props) => {
  return (0, import_jsx_runtime7.jsxs)("svg", { "aria-hidden": "true", fill: "none", height: props.size, viewBox: "0 0 36 36", width: props.size, children: [(0, import_jsx_runtime7.jsx)("path", { d: "M18.0001 15C17.2045 15 16.4414 15.3161 15.8788 15.8787C15.3162 16.4413 15.0001 17.2044 15.0001 18C15.0001 19.53 14.8501 21.765 14.6101 24", stroke: props.color ?? "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3" }), (0, import_jsx_runtime7.jsx)("path", { d: "M21.0002 19.6801C21.0002 23.2501 21.0002 29.2501 19.5002 33.0001", stroke: props.color ?? "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3" }), (0, import_jsx_runtime7.jsx)("path", { d: "M25.9348 31.53C26.1148 30.63 26.5798 28.08 26.6848 27", stroke: props.color ?? "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3" }), (0, import_jsx_runtime7.jsx)("path", { d: "M2.99976 18C2.99976 14.8518 3.99032 11.7833 5.83112 9.22935C7.67193 6.67536 10.2697 4.76531 13.2563 3.76975C16.243 2.77419 19.4672 2.74359 22.4723 3.6823C25.4773 4.621 28.1108 6.48141 29.9998 9", stroke: props.color ?? "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3" }), (0, import_jsx_runtime7.jsx)("path", { d: "M2.99976 24H3.01628", stroke: props.color ?? "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3" }), (0, import_jsx_runtime7.jsx)("path", { d: "M32.7 24C33 21 32.8965 15.969 32.7 15", stroke: props.color ?? "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3" }), (0, import_jsx_runtime7.jsx)("path", { d: "M7.49976 29.25C8.24976 27 8.99976 22.5 8.99976 18C8.99824 16.9783 9.17071 15.9638 9.50976 15", stroke: props.color ?? "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3" }), (0, import_jsx_runtime7.jsx)("path", { d: "M12.9751 33C13.2901 32.01 13.6501 31.02 13.8301 30", stroke: props.color ?? "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3" }), (0, import_jsx_runtime7.jsx)("path", { d: "M13.5 10.2C14.8686 9.40988 16.4211 8.99401 18.0014 8.99426C19.5818 8.99452 21.1342 9.41088 22.5025 10.2015C23.8708 10.9921 25.0069 12.129 25.7964 13.498C26.5859 14.867 27.001 16.4197 27 18V21", stroke: props.color ?? "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3" })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/GuestIcon.js
var import_jsx_runtime8 = __toESM(require_jsx_runtime(), 1);
var GuestIcon = (props) => {
  return (0, import_jsx_runtime8.jsxs)("svg", { fill: "none", height: props.size, role: "presentation", stroke: props.color ?? "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", viewBox: "0 0 24 24", width: props.size, xmlns: "http://www.w3.org/2000/svg", children: [(0, import_jsx_runtime8.jsx)("path", { d: "M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" }), (0, import_jsx_runtime8.jsx)("circle", { cx: "12", cy: "7", r: "4" })] });
};
...
var PhoneIcon = (props) => {
  const clipPathId = (0, import_react11.useId)();
  return (0, import_jsx_runtime10.jsxs)("svg", { fill: "none", height: props.size, role: "presentation", viewBox: "0 0 16 16", width: props.size, xmlns: "http://www.w3.org/2000/svg", children: [(0, import_jsx_runtime10.jsx)("g", { clipPath: `url(#${clipPathId})`, children: (0, import_jsx_runtime10.jsx)("path", { d: "M14.6669 11.2802V13.2802C14.6677 13.4659 14.6297 13.6497 14.5553 13.8198C14.4809 13.9899 14.3718 14.1426 14.235 14.2681C14.0982 14.3937 13.9367 14.4892 13.7608 14.5487C13.5849 14.6082 13.3985 14.6303 13.2136 14.6136C11.1622 14.3907 9.19161 13.6897 7.46028 12.5669C5.8495 11.5433 4.48384 10.1777 3.46028 8.56689C2.3336 6.8277 1.63244 4.84756 1.41361 2.78689C1.39695 2.60254 1.41886 2.41673 1.47795 2.24131C1.53703 2.06589 1.63199 1.90469 1.75679 1.76797C1.88159 1.63126 2.03348 1.52203 2.20281 1.44724C2.37213 1.37245 2.55517 1.33374 2.74028 1.33356H4.74028C5.06382 1.33038 5.37748 1.44495 5.62279 1.65592C5.8681 1.86689 6.02833 2.15986 6.07361 2.48023C6.15803 3.12027 6.31458 3.74871 6.54028 4.35356C6.62998 4.59218 6.64939 4.8515 6.59622 5.10081C6.54305 5.35012 6.41952 5.57897 6.24028 5.76023L5.39361 6.60689C6.34265 8.27592 7.72458 9.65786 9.39361 10.6069L10.2403 9.76023C10.4215 9.58099 10.6504 9.45746 10.8997 9.40429C11.149 9.35112 11.4083 9.37053 11.6469 9.46023C12.2518 9.68593 12.8802 9.84248 13.5203 9.92689C13.8441 9.97258 14.1399 10.1357 14.3513 10.3852C14.5627 10.6348 14.6751 10.9533 14.6669 11.2802Z", stroke: props.color ?? "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.33333" }) }), (0, import_jsx_runtime10.jsx)("defs", { children: (0, import_jsx_runtime10.jsx)("clipPath", { id: clipPathId, children: (0, import_jsx_runtime10.jsx)("rect", { fill: "white", height: "16", width: "16" }) }) })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/components/Skeleton.js
var import_jsx_runtime11 = __toESM(require_jsx_runtime(), 1);
var Skeleton = (props) => {
  return (0, import_jsx_runtime11.jsx)(SkeletonDiv, { className: props.className || "", color: props.color, style: {
    height: props.height,
...
var Img = (props) => {
  ...
  if (propSrc === void 0) {
    return (0, import_jsx_runtime12.jsx)(Skeleton, { height: heightPx, width: widthPx });
  }
  const getSrc = () => {
    try {
  ...
  return (0, import_jsx_runtime12.jsxs)("div", { style: {
    ...
    justifyItems: "center",
    position: "relative"
  }, children: [!isLoaded && (0, import_jsx_runtime12.jsx)(Skeleton, { height: heightPx, width: widthPx }), (0, import_jsx_runtime12.jsx)("img", { alt: props.alt || "", className: props.className, decoding: "async", draggable: false, height: props.height, loading: props.loading, onError: (e) => {
...
function WalletImage(props) {
  ...
  if ((image == null ? void 0 : image.authProvider) === "email") {
    return (0, import_jsx_runtime13.jsx)(EmailIcon, { color: theme.colors.accentText, size: props.size });
  }
  if ((image == null ? void 0 : image.authProvider) === "phone") {
    return (0, import_jsx_runtime13.jsx)(PhoneIcon, { color: theme.colors.accentText, size: props.size });
  }
  if ((image == null ? void 0 : image.authProvider) === "passkey") {
    return (0, import_jsx_runtime13.jsx)(FingerPrintIcon, { color: theme.colors.accentText, size: props.size });
  }
  if ((image == null ? void 0 : image.authProvider) === "wallet") {
    return (0, import_jsx_runtime13.jsx)(OutlineWalletIcon, { color: theme.colors.accentText, size: props.size });
  }
  if ((image == null ? void 0 : image.authProvider) === "guest") {
    return (0, import_jsx_runtime13.jsx)(GuestIcon, { color: theme.colors.accentText, size: props.size });
  }
  if (image == null ? void 0 : image.uri) {
    return (0, import_jsx_runtime13.jsx)(Img, { client: props.client, height: props.size, loading: "eager", src: image.uri, style: {
      borderRadius: radius.md,
      ...props.style
    }, width: props.size });
  }
  return (0, import_jsx_runtime13.jsx)(WalletImageQuery, { client: props.client, id: props.id, size: props.size });
}
function WalletImageQuery(props) {
  const walletImage = useWalletImage(props.id);
  if (walletImage.isFetched && !walletImage.data) {
    return (0, import_jsx_runtime13.jsx)(Img, { client: props.client, height: props.size, src: genericWalletIcon, width: props.size });
  }
  return (0, import_jsx_runtime13.jsx)(OutlineWalletIcon, { size: props.size });
}
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-Q23DGAZA.js.map
