...
function __decorate(decorators, target, key, desc) {
  ...
  else for (var i3 = decorators.length - 1; i3 >= 0; i3--) if (d3 = decorators[i3]) r3 = (c4 < 3 ? d3(r3) : c4 > 3 ? d3(target, key, r3) : d3(target, key)) || r3;
...
function __spreadArrays() {
  ...
  for (var r3 = Array(s3), k4 = 0, i3 = 0; i3 < il; i3++)
    for (var a2 = arguments[i3], j3 = 0, jl = a2.length; j3 < jl; j3++, k4++)
      r3[k4] = a2[j3];
  return r3;
}
function __await(v3) {
  ...
  function verb(n4) {
    if (g3[n4]) i3[n4] = function(v3) {
      return new Promise(function(a2, b3) {
        q.push([n4, v3, a2, b3]) > 1 || resume(n4, v3);
      });
    };
  }
...
function __asyncDelegator(o4) {
  ...
  function verb(n4, f3) {
    i3[n4] = o4[n4] ? function(v3) {
      return (p2 = !p2) ? { value: __await(o4[n4](v3)), done: n4 === "return" } : f3 ? f3(v3) : v3;
    } : f3;
  }
}
...
function __createBinding2(o4, m2, k4, k22) {
  if (k22 === void 0) k22 = k4;
  o4[k22] = m2[k4];
}
...
function __asyncDelegator2(o4) {
  ...
  function verb(n4, f3) {
    i3[n4] = o4[n4] ? function(v3) {
      return (p2 = !p2) ? { value: __await2(o4[n4](v3)), done: n4 === "return" } : f3 ? f3(v3) : v3;
    } : f3;
  }
}
function __asyncValues2(o4) {
  if (!Symbol.asyncIterator) throw new TypeError("Symbol.asyncIterator is not defined.");
  var m2 = o4[Symbol.asyncIterator], i3;
  return m2 ? m2.call(o4) : (o4 = typeof __values2 === "function" ? __values2(o4) : o4[Symbol.iterator](), i3 = {}, verb("next"), verb("throw"), verb("return"), i3[Symbol.asyncIterator] = function() {
    return this;
  }, i3);
  function verb(n4) {
    i3[n4] = o4[n4] && function(v3) {
...
function E(r3, e2, t = n) {
  const o4 = w(r3, e2, t), a2 = r3.child({ context: o4 });
  return b(a2, o4, t);
}
function C(r3) {
  var e2, t;
  const o4 = new m((e2 = r3.opts) == null ? void 0 : e2.level, r3.maxSizeInBytes);
  return { logger: (0, import_pino.default)(g(i({}, r3.opts), { level: "trace", browser: g(i({}, (t = r3.opts) == null ? void 0 : t.browser), { write: (a2) => o4.write(a2) }) })), chunkLoggerController: o4 };
}
function I(r3) {
  var e2;
...
function Cn(t, e2, n4, r3) {
  ...
  const o4 = BigInt(32), s3 = BigInt(4294967295), a2 = Number(n4 >> o4 & s3), u = Number(n4 & s3), i3 = r3 ? 4 : 0, D2 = r3 ? 0 : 4;
  t.setUint32(e2 + i3, a2, r3), t.setUint32(e2 + D2, u, r3);
}
var An = class extends xn {
  constructor(e2, n4, r3, o4) {
    super(), this.blockLen = e2, this.outputLen = n4, this.padOffset = r3, this.isLE = o4, this.finished = false, this.length = 0, this.pos = 0, this.destroyed = false, this.buffer = new Uint8Array(e2), this.view = _t(this.buffer);
  }
  update(e2) {
    De(this);
    ...
    const s3 = e2.length;
    for (let a2 = 0; a2 < s3; ) {
      const u = Math.min(o4 - this.pos, s3 - a2);
      if (u === o4) {
        const i3 = _t(e2);
        for (; o4 <= s3 - a2; a2 += o4) this.process(i3, a2);
        continue;
      }
      r3.set(e2.subarray(a2, a2 + u), this.pos), this.pos += u, a2 += u, this.pos === o4 && (this.process(n4, 0), this.pos = 0);
    }
    return this.length += e2.length, this.roundClean(), this;
  }
  digestInto(e2) {
    De(this), gn(e2, this), this.finished = true;
    const { buffer: n4, view: r3, blockLen: o4, isLE: s3 } = this;
    let { pos: a2 } = this;
    n4[a2++] = 128, this.buffer.subarray(a2).fill(0), this.padOffset > o4 - a2 && (this.process(r3, 0), a2 = 0);
    for (let l5 = a2; l5 < o4; l5++) n4[l5] = 0;
    ...
    for (let l5 = 0; l5 < D2; l5++) u.setUint32(4 * l5, c4[l5], s3);
  }
  digest() {
  ...
  _cloneInto(e2) {
    ...
    const { blockLen: n4, buffer: r3, length: o4, finished: s3, destroyed: a2, pos: u } = this;
    return e2.length = o4, e2.pos = u, e2.finished = s3, e2.destroyed = a2, o4 % n4 && e2.buffer.set(r3), e2;
  }
};
...
var jn = (t, e2, n4, r3, o4) => e2 + n4 + r3 + o4 + (t / 2 ** 32 | 0) | 0;
var Zn = (t, e2, n4, r3, o4) => (t >>> 0) + (e2 >>> 0) + (n4 >>> 0) + (r3 >>> 0) + (o4 >>> 0);
var Gn = (t, e2, n4, r3, o4, s3) => e2 + n4 + r3 + o4 + s3 + (t / 2 ** 32 | 0) | 0;
...
var Jn = class extends An {
  ...
  get() {
    const { Ah: e2, Al: n4, Bh: r3, Bl: o4, Ch: s3, Cl: a2, Dh: u, Dl: i3, Eh: D2, El: c4, Fh: l5, Fl: p2, Gh: w3, Gl: h4, Hh: g3, Hl: S2 } = this;
    return [e2, n4, r3, o4, s3, a2, u, i3, D2, c4, l5, p2, w3, h4, g3, S2];
  }
  set(e2, n4, r3, o4, s3, a2, u, i3, D2, c4, l5, p2, w3, h4, g3, S2) {
    this.Ah = e2 | 0, this.Al = n4 | 0, this.Bh = r3 | 0, this.Bl = o4 | 0, this.Ch = s3 | 0, this.Cl = a2 | 0, this.Dh = u | 0, this.Dl = i3 | 0, this.Eh = D2 | 0, this.El = c4 | 0, this.Fh = l5 | 0, this.Fl = p2 | 0, this.Gh = w3 | 0, this.Gl = h4 | 0, this.Hh = g3 | 0, this.Hl = S2 | 0;
  }
  process(e2, n4) {
    for (let d3 = 0; d3 < 16; d3++, n4 += 4) P[d3] = e2.getUint32(n4), Q[d3] = e2.getUint32(n4 += 4);
    for (let d3 = 16; d3 < 80; d3++) {
      const m2 = P[d3 - 15] | 0, F = Q[d3 - 15] | 0, q = x2.rotrSH(m2, F, 1) ^ x2.rotrSH(m2, F, 8) ^ x2.shrSH(m2, F, 7), z3 = x2.rotrSL(m2, F, 1) ^ x2.rotrSL(m2, F, 8) ^ x2.shrSL(m2, F, 7), I2 = P[d3 - 2] | 0, O3 = Q[d3 - 2] | 0, ot = x2.rotrSH(I2, O3, 19) ^ x2.rotrBH(I2, O3, 61) ^ x2.shrSH(I2, O3, 6), tt = x2.rotrSL(I2, O3, 19) ^ x2.rotrBL(I2, O3, 61) ^ x2.shrSL(I2, O3, 6), st = x2.add4L(z3, tt, Q[d3 - 7], Q[d3 - 16]), at = x2.add4H(st, q, ot, P[d3 - 7], P[d3 - 16]);
      P[d3] = at | 0, Q[d3] = st | 0;
    }
    let { Ah: r3, Al: o4, Bh: s3, Bl: a2, Ch: u, Cl: i3, Dh: D2, Dl: c4, Eh: l5, El: p2, Fh: w3, Fl: h4, Gh: g3, Gl: S2, Hh: v3, Hl: L2 } = this;
    for (let d3 = 0; d3 < 80; d3++) {
      const m2 = x2.rotrSH(l5, p2, 14) ^ x2.rotrSH(l5, p2, 18) ^ x2.rotrBH(l5, p2, 41), F = x2.rotrSL(l5, p2, 14) ^ x2.rotrSL(l5, p2, 18) ^ x2.rotrBL(l5, p2, 41), q = l5 & w3 ^ ~l5 & g3, z3 = p2 & h4 ^ ~p2 & S2, I2 = x2.add5L(L2, F, z3, Yn[d3], Q[d3]), O3 = x2.add5H(I2, v3, m2, q, Vn[d3], P[d3]), ot = I2 | 0, tt = x2.rotrSH(r3, o4, 28) ^ x2.rotrBH(r3, o4, 34) ^ x2.rotrBH(r3, o4, 39), st = x2.rotrSL(r3, o4, 28) ^ x2.rotrBL(r3, o4, 34) ^ x2.rotrBL(r3, o4, 39), at = r3 & s3 ^ r3 & u ^ s3 & u, Ct = o4 & a2 ^ o4 & i3 ^ a2 & i3;
      v3 = g3 | 0, L2 = S2 | 0, g3 = w3 | 0, S2 = h4 | 0, w3 = l5 | 0, h4 = p2 | 0, { h: l5, l: p2 } = x2.add(D2 | 0, c4 | 0, O3 | 0, ot | 0), D2 = u | 0, c4 = i3 | 0, u = s3 | 0, i3 = a2 | 0, s3 = r3 | 0, a2 = o4 | 0;
      const At = x2.add3L(ot, st, Ct);
      r3 = x2.add3H(At, O3, tt, at), o4 = At | 0;
    }
    ({ h: r3, l: o4 } = x2.add(this.Ah | 0, this.Al | 0, r3 | 0, o4 | 0)), { h: s3, l: a2 } = x2.add(this.Bh | 0, this.Bl | 0, s3 | 0, a2 | 0), { h: u, l: i3 } = x2.add(this.Ch | 0, this.Cl | 0, u | 0, i3 | 0), { h: D2, l: c4 } = x2.add(this.Dh | 0, this.Dl | 0, D2 | 0, c4 | 0), { h: l5, l: p2 } = x2.add(this.Eh | 0, this.El | 0, l5 | 0, p2 | 0), { h: w3, l: h4 } = x2.add(this.Fh | 0, this.Fl | 0, w3 | 0, h4 | 0), { h: g3, l: S2 } = x2.add(this.Gh | 0, this.Gl | 0, g3 | 0, S2 | 0), { h: v3, l: L2 } = x2.add(this.Hh | 0, this.Hl | 0, v3 | 0, L2 | 0), this.set(r3, o4, s3, a2, u, i3, D2, c4, l5, p2, w3, h4, g3, S2, v3, L2);
  }
  roundClean() {
    P.fill(0), Q.fill(0);
  }
...
function Ot(t, e2, n4 = {}) {
  const r3 = (o4, s3, a2) => {
    ...
    const i3 = t[o4];
    if (!(a2 && i3 === void 0) && !u(i3, t)) throw new Error("param " + String(o4) + " is invalid. Expected " + s3 + ", got " + i3);
  };
  for (const [o4, s3] of Object.entries(e2)) r3(o4, s3, false);
  for (const [o4, s3] of Object.entries(n4)) r3(o4, s3, true);
  return t;
}
function xe(t) {
...
function Ae(t, e2) {
  ...
  let n4 = H(t, e2), r3 = e2, o4 = M, s3 = N;
  for (; n4 !== M; ) {
    const u = r3 / n4, i3 = r3 % n4, D2 = o4 - s3 * u;
    r3 = n4, n4 = i3, o4 = s3, s3 = D2;
  }
...
function sr(t) {
  ...
  return function(u, i3) {
    ...
    let D2 = r3, c4 = u.pow(u.mul(u.ONE, o4), n4), l5 = u.pow(i3, s3), p2 = u.pow(i3, n4);
    for (; !u.eql(p2, u.ONE); ) {
      if (u.eql(p2, u.ZERO)) return u.ZERO;
      let w3 = 1;
      for (let g3 = u.sqr(p2); w3 < D2 && !u.eql(g3, u.ONE); w3++) g3 = u.sqr(g3);
      const h4 = u.pow(c4, N << BigInt(D2 - w3 - 1));
      c4 = u.sqr(h4), l5 = u.mul(l5, h4), p2 = u.mul(p2, c4), D2 = w3;
    }
    return l5;
  };
}
function ir(t) {
  ...
  if (t % Ce === Be) {
    const e2 = (t - Be) / Ce;
    return function(r3, o4) {
      const s3 = r3.mul(o4, nt), a2 = r3.pow(s3, e2), u = r3.mul(o4, a2), i3 = r3.mul(r3.mul(u, nt), a2), D2 = r3.mul(u, r3.sub(i3, r3.ONE));
...
function fr(t, e2, n4) {
  ...
  if (n4 === N) return e2;
  let r3 = t.ONE, o4 = e2;
  for (; n4 > M; ) n4 & N && (r3 = t.mul(r3, o4)), o4 = t.sqr(o4), n4 >>= N;
  return r3;
}
function Dr(t, e2) {
  const n4 = new Array(e2.length), r3 = e2.reduce((s3, a2, u) => t.is0(a2) ? s3 : (n4[u] = s3, t.mul(s3, a2)), t.ONE), o4 = t.inv(r3);
  return e2.reduceRight((s3, a2, u) => t.is0(a2) ? s3 : (n4[u] = t.mul(s3, n4[u]), t.mul(s3, a2)), o4), n4;
}
function me(t, e2) {
...
function _e(t, e2, n4 = false, r3 = {}) {
  ...
  let a2;
  const u = Object.freeze({ ORDER: t, isLE: n4, BITS: o4, BYTES: s3, MASK: er(o4), ZERO: M, ONE: N, create: (i3) => H(i3, t), isValid: (i3) => {
    if (typeof i3 != "bigint") throw new Error("invalid field element: expected bigint, got " + typeof i3);
    return M <= i3 && i3 < t;
  }, is0: (i3) => i3 === M, isOdd: (i3) => (i3 & N) === N, neg: (i3) => H(-i3, t), eql: (i3, D2) => i3 === D2, sqr: (i3) => H(i3 * i3, t), add: (i3, D2) => H(i3 + D2, t), sub: (i3, D2) => H(i3 - D2, t), mul: (i3, D2) => H(i3 * D2, t), pow: (i3, D2) => fr(u, i3, D2), div: (i3, D2) => H(i3 * Ae(D2, t), t), sqrN: (i3) => i3 * i3, addN: (i3, D2) => i3 + D2, subN: (i3, D2) => i3 - D2, mulN: (i3, D2) => i3 * D2, inv: (i3) => Ae(i3, t), sqrt: r3.sqrt || ((i3) => (a2 || (a2 = ir(t)), a2(u, i3))), invertBatch: (i3) => Dr(u, i3), cmov: (i3, D2, c4) => c4 ? D2 : i3, toBytes: (i3) => n4 ? Nt(i3, s3) : ge(i3, s3), fromBytes: (i3) => {
...
function lr(t, e2) {
  return { constTimeNegate: zt, hasPrecomputes(n4) {
    ...
    const { windows: o4, windowSize: s3 } = Mt(r3, e2), a2 = [];
    let u = n4, i3 = u;
    ...
    const D2 = BigInt(2 ** n4 - 1), c4 = 2 ** n4, l5 = BigInt(n4);
    for (let p2 = 0; p2 < s3; p2++) {
      const w3 = p2 * a2;
      let h4 = Number(o4 & D2);
      o4 >>= l5, h4 > a2 && (h4 -= c4, o4 += gt);
      const g3 = w3, S2 = w3 + Math.abs(h4) - 1, v3 = p2 % 2 !== 0, L2 = h4 < 0;
      h4 === 0 ? i3 = i3.add(zt(v3, r3[g3])) : u = u.add(zt(L2, r3[S2]));
    }
    return { p: u, f: i3 };
  }, wNAFUnsafe(n4, r3, o4, s3 = t.ZERO) {
    const { windows: a2, windowSize: u } = Mt(n4, e2), i3 = BigInt(2 ** n4 - 1), D2 = 2 ** n4, c4 = BigInt(n4);
    for (let l5 = 0; l5 < a2; l5++) {
      const p2 = l5 * u;
      if (o4 === Se) break;
      let w3 = Number(o4 & i3);
      if (o4 >>= c4, w3 > u && (w3 -= D2, o4 += gt), w3 === 0) continue;
      let h4 = r3[p2 + Math.abs(w3) - 1];
      w3 < 0 && (h4 = h4.negate()), s3 = s3.add(h4);
    }
    return s3;
  }, getPrecomputes(n4, r3, o4) {
    let s3 = qt.get(r3);
    return s3 || (s3 = this.precomputeWindow(r3, n4), n4 !== 1 && qt.set(r3, o4(s3))), s3;
  }, wNAFCached(n4, r3, o4) {
    const s3 = $t(n4);
    return this.wNAF(s3, this.getPrecomputes(s3, n4, o4), r3);
  }, wNAFCachedUnsafe(n4, r3, o4, s3) {
    const a2 = $t(n4);
    return a2 === 1 ? this.unsafeLadder(n4, r3, s3) : this.wNAFUnsafe(a2, this.getPrecomputes(a2, n4, o4), r3, s3);
  }, setWindowSize(n4, r3) {
...
function br(t, e2, n4, r3) {
  ...
  const o4 = t.ZERO, s3 = tr(BigInt(n4.length)), a2 = s3 > 12 ? s3 - 3 : s3 > 4 ? s3 - 2 : s3 ? 2 : 1, u = (1 << a2) - 1, i3 = new Array(u + 1).fill(o4), D2 = Math.floor((e2.BITS - 1) / a2) * a2;
  let c4 = o4;
  for (let l5 = D2; l5 >= 0; l5 -= a2) {
    i3.fill(o4);
    for (let w3 = 0; w3 < r3.length; w3++) {
      const h4 = r3[w3], g3 = Number(h4 >> BigInt(l5) & BigInt(u));
      i3[g3] = i3[g3].add(n4[w3]);
    }
    let p2 = o4;
    for (let w3 = i3.length - 1, h4 = o4; w3 > 0; w3--) h4 = h4.add(i3[w3]), p2 = p2.add(h4);
...
function yr(t) {
  const e2 = gr(t), { Fp: n4, n: r3, prehash: o4, hash: s3, randomBytes: a2, nByteLength: u, h: i3 } = e2, D2 = yt << BigInt(u * 8) - j, c4 = n4.create, l5 = _e(e2.n, e2.nBitLength), p2 = e2.uvRatio || ((y3, f3) => {
    try {
      return { isValid: true, value: n4.sqrt(y3 * n4.inv(f3)) };
    } catch {
      return { isValid: false, value: G };
    }
  }), w3 = e2.adjustScalarBytes || ((y3) => y3), h4 = e2.domain || ((y3, f3, b3) => {
    if (Tt("phflag", b3), f3.length || b3) throw new Error("Contexts/pre-hash are not supported");
    return y3;
  });
  function g3(y3, f3) {
  ...
  const v3 = xe((y3, f3) => {
    const { ex: b3, ey: E3, ez: B2 } = y3, C3 = y3.is0();
    f3 == null && (f3 = C3 ? wr : n4.inv(B2));
    const A2 = c4(b3 * f3), U2 = c4(E3 * f3), _3 = c4(B2 * f3);
    ...
    const { ex: E3, ey: B2, ez: C3, et: A2 } = y3, U2 = c4(E3 * E3), _3 = c4(B2 * B2), T2 = c4(C3 * C3), $ = c4(T2 * T2), R = c4(U2 * f3), V = c4(T2 * c4(R + _3)), Y = c4($ + c4(b3 * c4(U2 * _3)));
  ...
  class d3 {
    constructor(f3, b3, E3, B2) {
      this.ex = f3, this.ey = b3, this.ez = E3, this.et = B2, g3("x", f3), g3("y", b3), g3("z", E3), g3("t", B2), Object.freeze(this);
    }
    get x() {
    ...
    static fromAffine(f3) {
      ...
      const { x: b3, y: E3 } = f3 || {};
      return g3("x", b3), g3("y", E3), new d3(b3, E3, j, c4(b3 * E3));
    }
    static normalizeZ(f3) {
      const b3 = n4.invertBatch(f3.map((E3) => E3.ez));
      return f3.map((E3, B2) => E3.toAffine(b3[B2])).map(d3.fromAffine);
    }
    static msm(f3, b3) {
      return br(d3, l5, f3, b3);
    }
    _setWindowSize(f3) {
    ...
    equals(f3) {
      S2(f3);
      const { ex: b3, ey: E3, ez: B2 } = this, { ex: C3, ey: A2, ez: U2 } = f3, _3 = c4(b3 * U2), T2 = c4(C3 * B2), $ = c4(E3 * U2), R = c4(A2 * B2);
      return _3 === T2 && $ === R;
    }
    is0() {
    ...
    double() {
      const { a: f3 } = e2, { ex: b3, ey: E3, ez: B2 } = this, C3 = c4(b3 * b3), A2 = c4(E3 * E3), U2 = c4(yt * c4(B2 * B2)), _3 = c4(f3 * C3), T2 = b3 + E3, $ = c4(c4(T2 * T2) - C3 - A2), R = _3 + A2, V = R - U2, Y = _3 - A2, Z = c4($ * V), X = c4(R * Y), et = c4($ * Y), pt = c4(V * R);
      return new d3(Z, X, pt, et);
    }
    add(f3) {
      S2(f3);
      const { a: b3, d: E3 } = e2, { ex: B2, ey: C3, ez: A2, et: U2 } = this, { ex: _3, ey: T2, ez: $, et: R } = f3;
      if (b3 === BigInt(-1)) {
        const re = c4((C3 - B2) * (T2 + _3)), oe = c4((C3 + B2) * (T2 - _3)), mt = c4(oe - re);
      ...
      const V = c4(B2 * _3), Y = c4(C3 * T2), Z = c4(U2 * E3 * R), X = c4(A2 * $), et = c4((B2 + C3) * (_3 + T2) - V - Y), pt = X - Z, ee = X + Z, ne = c4(Y - b3 * V), un = c4(et * pt), cn = c4(ee * ne), an = c4(et * ne), fn = c4(pt * ee);
    ...
    multiplyUnsafe(f3, b3 = d3.ZERO) {
      const E3 = f3;
      return ft("scalar", E3, G, r3), E3 === G ? F : this.is0() || E3 === j ? this : q.wNAFCachedUnsafe(this, E3, d3.normalizeZ, b3);
    }
    isSmallOrder() {
    ...
    static fromHex(f3, b3 = false) {
      const { d: E3, a: B2 } = e2, C3 = n4.BYTES;
      f3 = W("pointHex", f3, C3), Tt("zip215", b3);
      const A2 = f3.slice(), U2 = f3[C3 - 1];
      A2[C3 - 1] = U2 & -129;
      const _3 = Et(A2), T2 = b3 ? D2 : n4.ORDER;
      ft("pointHex.y", _3, G, T2);
      const $ = c4(_3 * _3), R = c4($ - j), V = c4(E3 * $ - B2);
      ...
      return et !== X && (Z = c4(-Z)), d3.fromAffine({ x: Z, y: _3 });
    }
    static fromPrivateKey(f3) {
      return O3(f3).point;
    }
    toRawBytes() {
      const { x: f3, y: b3 } = this.toAffine(), E3 = Nt(b3, n4.BYTES);
  ...
  function O3(y3) {
    ...
    const b3 = W("hashed private key", s3(y3), 2 * f3), E3 = w3(b3.slice(0, f3)), B2 = b3.slice(f3, 2 * f3), C3 = I2(E3), A2 = m2.multiply(C3), U2 = A2.toRawBytes();
  ...
  function tt(y3 = new Uint8Array(), ...f3) {
    const b3 = ye(...f3);
    return I2(s3(h4(b3, W("context", y3), !!o4)));
  }
  function st(y3, f3, b3 = {}) {
    y3 = W("message", y3), o4 && (y3 = o4(y3));
    const { prefix: E3, scalar: B2, pointBytes: C3 } = O3(f3), A2 = tt(b3.context, E3, y3), U2 = m2.multiply(A2).toRawBytes(), _3 = tt(b3.context, U2, C3, y3), T2 = z3(A2 + _3 * B2);
    ft("signature.s", T2, G, r3);
    const $ = ye(U2, Nt(T2, n4.BYTES));
    return W("result", $, n4.BYTES * 2);
  }
  const at = Er;
  function Ct(y3, f3, b3, E3 = at) {
    const { context: B2, zip215: C3 } = E3, A2 = n4.BYTES;
    y3 = W("signature", y3, 2 * A2), f3 = W("message", f3), b3 = W("publicKey", b3, A2), C3 !== void 0 && Tt("zip215", C3), o4 && (f3 = o4(f3));
    const U2 = Et(y3.slice(A2, 2 * A2));
    let _3, T2, $;
    try {
      _3 = d3.fromHex(b3, C3), T2 = d3.fromHex(y3.slice(0, A2), C3), $ = m2.multiplyUnsafe(U2);
    } catch {
      return false;
    }
    if (!C3 && _3.isSmallOrder()) return false;
    const R = tt(B2, T2.toRawBytes(), _3.toRawBytes(), f3);
    return T2.add(_3.multiplyUnsafe(R)).subtract($).clearCofactor().equals(d3.ZERO);
  }
  return m2._setWindowSize(8), { CURVE: e2, getPublicKey: ot, sign: st, verify: Ct, ExtendedPoint: d3, utils: { getExtendedPublicKey: O3, randomPrivateKey: () => a2(n4.BYTES), precompute(y3 = 8, f3 = d3.BASE) {
...
var Cr = BigInt(8);
function Ar(t) {
  const e2 = BigInt(10), n4 = BigInt(20), r3 = BigInt(40), o4 = BigInt(80), s3 = kt, u = t * t % s3 * t % s3, i3 = J(u, Te, s3) * u % s3, D2 = J(i3, xr, s3) * t % s3, c4 = J(D2, Br, s3) * D2 % s3, l5 = J(c4, e2, s3) * c4 % s3, p2 = J(l5, n4, s3) * l5 % s3, w3 = J(p2, r3, s3) * p2 % s3, h4 = J(w3, o4, s3) * w3 % s3, g3 = J(h4, o4, s3) * w3 % s3, S2 = J(g3, e2, s3) * c4 % s3;
...
function _r(t, e2) {
  const n4 = kt, r3 = H(e2 * e2 * e2, n4), o4 = H(r3 * r3 * e2, n4), s3 = Ar(t * o4).pow_p_5_8;
  let a2 = H(t * r3 * s3, n4);
  const u = H(e2 * a2 * a2, n4), i3 = a2, D2 = H(a2 * Ue, n4), c4 = u === t, l5 = u === H(-t, n4), p2 = u === H(-t * Ue, n4);
  return c4 && (a2 = i3), (l5 || p2) && (a2 = D2), ur(a2, n4) && (a2 = H(-a2, n4)), { isValid: c4 || l5, value: a2 };
}
...
function Ir(t, e2) {
  ...
  for (var o4 = 0; o4 < t.length; o4++) {
    var s3 = t.charAt(o4), a2 = s3.charCodeAt(0);
    if (n4[a2] !== 255) throw new TypeError(s3 + " is ambiguous");
    n4[a2] = o4;
  }
  var u = t.length, i3 = t.charAt(0), D2 = Math.log(u) / Math.log(256), c4 = Math.log(256) / Math.log(u);
  function l5(h4) {
    ...
    for (var g3 = 0, S2 = 0, v3 = 0, L2 = h4.length; v3 !== L2 && h4[v3] === 0; ) v3++, g3++;
    for (var d3 = (L2 - v3) * c4 + 1 >>> 0, m2 = new Uint8Array(d3); v3 !== L2; ) {
      for (var F = h4[v3], q = 0, z3 = d3 - 1; (F !== 0 || q < S2) && z3 !== -1; z3--, q++) F += 256 * m2[z3] >>> 0, m2[z3] = F % u >>> 0, F = F / u >>> 0;
      if (F !== 0) throw new Error("Non-zero carry");
      S2 = q, v3++;
    }
    for (var I2 = d3 - S2; I2 !== d3 && m2[I2] === 0; ) I2++;
    for (var O3 = i3.repeat(g3); I2 < d3; ++I2) O3 += t.charAt(m2[I2]);
    return O3;
  }
  function p2(h4) {
    ...
    var g3 = 0;
    if (h4[g3] !== " ") {
      for (var S2 = 0, v3 = 0; h4[g3] === i3; ) S2++, g3++;
      for (var L2 = (h4.length - g3) * D2 + 1 >>> 0, d3 = new Uint8Array(L2); h4[g3]; ) {
        var m2 = n4[h4.charCodeAt(g3)];
        if (m2 === 255) return;
      ...
      if (h4[g3] !== " ") {
        for (var z3 = L2 - v3; z3 !== L2 && d3[z3] === 0; ) z3++;
        for (var I2 = new Uint8Array(S2 + (L2 - z3)), O3 = S2; z3 !== L2; ) I2[O3++] = d3[z3++];
        return I2;
      }
    }
  }
...
var Mr = (t, e2, n4, r3) => {
  ...
  for (let c4 = 0; c4 < s3; ++c4) {
    ...
    i3 = i3 << n4 | l5, u += n4, u >= 8 && (u -= 8, a2[D2++] = 255 & i3 >> u);
  }
...
var qr = (t, e2, n4) => {
  ...
  let s3 = "", a2 = 0, u = 0;
  for (let i3 = 0; i3 < t.length; ++i3) for (u = u << 8 | t[i3], a2 += 8; a2 > n4; ) a2 -= n4, s3 += e2[o4 & u >> a2];
  if (a2 && (s3 += e2[o4 & u << n4 - a2]), r3) for (; s3.length * n4 & 7; ) s3 += "=";
  return s3;
};
var k2 = ({ name: t, prefix: e2, bitsPerChar: n4, alphabet: r3 }) => Bt({ prefix: e2, name: t, encode(o4) {
  return qr(o4, r3, n4);
}, decode(o4) {
...
var ke = 127;
function Pt(t, r3) {
  var n4 = 0, r3 = r3 || 0, o4 = 0, s3 = r3, a2, u = t.length;
  do {
    if (s3 >= u) throw Pt.bytes = 0, new RangeError("Could not decode varint");
    a2 = t[s3++], n4 += o4 < 28 ? (a2 & ke) << o4 : (a2 & ke) * Math.pow(2, o4), o4 += 7;
  } while (a2 >= Uo);
...
var Qt = (t, e2) => {
  const n4 = e2.byteLength, r3 = Ze(t), o4 = r3 + Ze(n4), s3 = new Uint8Array(o4 + n4);
  return je(t, s3, 0), je(n4, s3, r3), s3.set(e2, o4), new Ro(t, n4, e2, s3);
};
var Ro = class {
  constructor(e2, n4, r3, o4) {
...
function sn(t) {
  const e2 = t.split(ut), n4 = lt(e2[0]), r3 = lt(e2[1]), o4 = nn(e2[2]), s3 = rt(e2.slice(0, 2).join(ut), xt);
  return { header: n4, payload: r3, signature: o4, data: s3 };
}
function Po(t = he(Ne)) {
  const e2 = Rt.getPublicKey(t);
  return { secretKey: Oe([t, e2]), publicKey: e2 };
}
async function Qo(t, e2, n4, r3, o4 = (0, import_time.fromMiliseconds)(Date.now())) {
  const s3 = { alg: jt, typ: Zt }, a2 = Qe(r3.publicKey), u = o4 + n4, i3 = { iss: a2, sub: t, aud: e2, iat: o4, exp: u }, D2 = rn({ header: s3, payload: i3 }), c4 = Rt.sign(D2, r3.secretKey.slice(0, 32));
...
var O2 = async (i3, t, e2) => {
  ...
  await t.setItem(n4, y2), e2(t), j2(i3, m2);
};
var j2 = async (i3, t) => {
...
var f2 = class {
  ...
  register(e2 = this.url) {
    ...
    return this.url = e2, this.registering = true, new Promise((t, n4) => {
      const s3 = (0, esm_exports.isReactNative)() ? void 0 : { rejectUnauthorized: !isLocalhostUrl(e2) }, o4 = new b2(e2, [], s3);
      w2() ? o4.onerror = (i3) => {
        const a2 = i3;
  ...
  onError(e2, t) {
    const n4 = this.parseError(t), s3 = n4.message || n4.toString(), o4 = formatJsonRpcError(e2, s3);
...
*/
//# sourceMappingURL=chunk-GVSFVDC5.js.map
