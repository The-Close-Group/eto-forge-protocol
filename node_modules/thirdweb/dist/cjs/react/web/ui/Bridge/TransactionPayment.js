...
function TransactionPayment({ uiOptions, client, onContinue, connectOptions, showThirdwebBranding = true, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(WithHeader_js_1.WithHeader, { client: client, defaultTitle: "Transaction", uiOptions: uiOptions, children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { center: "y", flex: "row", gap: "3xs", style: {
                    ...
                    if (transactionDataQuery.data?.tokenInfo) {
                        onContinue(Math.max(0, Number(transactionDataQuery.data.totalCost) -
                            Number(userBalance ?? "0")).toString(), transactionDataQuery.data.tokenInfo, (0, address_js_1.getAddress)(activeAccount.address));
                    }
                }, style: {
