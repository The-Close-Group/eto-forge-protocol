...
function PaymentMethodTokenRow({ paymentMethod, destinationToken, destinationAmount, client, onPaymentMethodSelected, feePayer, }) {
...
function TokenSelection({ paymentMethods, paymentMethodsLoading, client, onPaymentMethodSelected, onBack, destinationToken, destinationAmount, feePayer, }) {
    const theme = (0, CustomThemeProvider_js_1.useCustomTheme)();
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", size: "md", children: "Select payment token" }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "sm" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "column", gap: "sm", style: {
                    ...
                    .map((method) => ((0, jsx_runtime_1.jsx)(PaymentMethodTokenRow, { client: client, destinationAmount: destinationAmount, destinationToken: destinationToken, feePayer: feePayer, onPaymentMethodSelected: onPaymentMethodSelected, paymentMethod: method }, `${method.originToken.address}-${method.originToken.chainId}`))) })] }));
}
