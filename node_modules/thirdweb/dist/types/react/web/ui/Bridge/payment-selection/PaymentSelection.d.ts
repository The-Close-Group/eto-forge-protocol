...
export declare function PaymentSelection({ destinationToken, client, destinationAmount, receiverAddress, onPaymentMethodSelected, onError, onBack, connectOptions, connectLocale, includeDestinationToken, paymentMethods, feePayer, currency, }: PaymentSelectionProps): import("react/jsx-runtime").JSX.Element;
