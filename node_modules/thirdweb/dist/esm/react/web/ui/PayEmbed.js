...
export function PayEmbed(props) {
    ...
    if (props.payOptions?.mode === "fund_wallet" &&
        ...
        return (_jsx(BuyWidget, { amount: props.payOptions.prefillBuy.amount || "0.01", chain: props.payOptions.prefillBuy.chain, client: props.client, onSuccess: () => props.payOptions?.onPurchaseSuccess?.(), paymentMethods: props.payOptions?.buyWithFiat === false
                ? ["crypto"]
