...
export function TransactionWidget(props) {
    ...
    if (!localeQuery.data || bridgeDataQuery.isLoading) {
        ...
        content = (_jsxs("div", { style: {
                alignItems: "center",
                display: "flex",
                flexDirection: "column",
                justifyContent: "center",
                minHeight: "350px",
            }, children: [_jsx(AccentFailIcon, { size: iconSize["3xl"] }), _jsx(Spacer, { y: "lg" }), _jsx(Text, { color: "secondaryText", size: "md", children: bridgeDataQuery.error.message })] }));
    }
