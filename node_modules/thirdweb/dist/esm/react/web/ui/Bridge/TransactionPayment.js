...
export function TransactionPayment({ uiOptions, client, onContinue, connectOptions, showThirdwebBranding = true, }) {
    ...
    return (_jsxs(WithHeader, { client: client, defaultTitle: "Transaction", uiOptions: uiOptions, children: [_jsxs(Container, { center: "y", flex: "row", gap: "3xs", style: {
                    ...
                    if (transactionDataQuery.data?.tokenInfo) {
                        onContinue(Math.max(0, Number(transactionDataQuery.data.totalCost) -
                            Number(userBalance ?? "0")).toString(), transactionDataQuery.data.tokenInfo, getAddress(activeAccount.address));
                    }
                }, style: {
